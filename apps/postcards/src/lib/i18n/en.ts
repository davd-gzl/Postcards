...
export const en = {
  ...
  "trip.compose.stopsHeading": "Stops",
  "trip.compose.stopsHint": "Add the places you passed through, in order — airports and cities.",
  "trip.compose.emptyStops": "No stops yet. Add the airports and cities you passed through.",
  "trip.compose.addStop": "Add a stop",
  "trip.compose.addStopPlaceholder": "Search a city or airport…",
  ...
  "trip.compose.nameLabel": "Trip name",
  "trip.compose.namePlaceholder": "e.g. Japan 2024",
