...
export const en = {
  ...
  "stats.kpi.bigCities": "big cities",
  "stats.kpi.megaCities": "megacities",
  "stats.kpi.airports": "airports",
  "stats.kpi.stations": "stations",
  "stats.kpi.monuments": "monuments",
  "stats.kpi.monumentsTitle": "See the monuments list",
  "stats.kpi.countriesTitle": "See your countries",
  "stats.byContinent.title": "By continent",
  "stats.bands.title": "By city size",
  "stats.bands.mega": "megacities (1M+)",
  "stats.bands.large": "large (100k+)",
  "stats.bands.small": "towns",
  "stats.bands.aria": "Visited city sizes: {mega} megacities, {large} large cities, {small} towns",
  ...
  "stats.country.stationBarAria": "{name}: railway stations visited",
  ...
  "stats.country.metricStations": "Railway stations",
  "stats.country.metricStationsDetail": "{pct} · {visited}/{total} stations",
  ...
  "places.photos.empty": "No photos yet — add some to a place and they'll show up here.",
  "places.photos.openAria": "Open {name}",
  "places.collection.passport": "Passport",
  // ── Places: the two-axis explore & track surface (spec 018) ──────────────
  "places.kindLabel": "Kind",
  "places.statusLabel": "Show",
  "places.kindAria": "Place kind",
  "places.statusAria": "Which places to show",
  "places.status.all": "All",
  "places.status.visited": "Visited",
  "places.status.wishlist": "Wishlist",
  "places.status.favorites": "Favorites",
  "places.status.notVisited": "Not visited",
  "places.browse.searchPlaceholder": "Search the whole world…",
  "places.browse.searchAria": "Search all places",
  "places.browse.emptyStatus": "No places match this filter.",
  "places.browse.widen": "Show all",
  "places.all.notVisitedHint":
    "“Not visited” means the whole world — pick a kind (Cities, Monuments or Airports) above to explore it.",
  "places.all.discoverBtn": "Browse world cities",
  ...
  "backup.export.all": "Save everything (.zip)",
  "backup.export.data": "Export data (.json)",
  "backup.export.csv": "Export places (.csv)",
  "backup.export.md": "Export summary (.md)",
  "backup.import": "Import…",
  "backup.msg.exportZipErr": "Couldn't build the archive. Your data is unchanged.",
  "backup.msg.zipUnreadable": "Couldn't read this archive — it may be incomplete.",
  ...
  "travel.airports.title": "Your most-visited airports",
  "travel.airports.aria": "Your most-visited airports, most visits first",
  "travel.airports.count_one": "{count} visit",
  "travel.airports.count_other": "{count} visits",
  "travel.airports.focusAria": "Show {name} on the map",
  "travel.editingNote": "Editing a trip",
  "travel.nameOptional": "Trip name (optional)",
  "travel.namePlaceholder": "Name this trip",
  ...
  "travel.reconstructBtn": "Reconstruct a journey",
  "travel.empty":
  ...
  "trip.compose.newTitle": "New trip",
  "trip.compose.editTitle": "Edit trip",
  "trip.compose.back": "Back",
  "trip.compose.stopsHeading": "Your trip",
  ...
  "trip.compose.searchPlaceholder": "Search an airport (e.g. CDG) or city…",
  ...
  "trip.compose.mapCanvasAria": "Map of your places — tap a pin to preview it, then add it to the trip",
  "trip.compose.filterAria": "Show which pins",
  "trip.compose.filterAll": "All",
  "trip.compose.filterCities": "Cities",
  "trip.compose.filterAirports": "Airports",
  "trip.compose.confirmAdd": "Add to trip",
  ...
  "trip.compose.moveUp": "Move {name} up",
  "trip.compose.moveDown": "Move {name} down",
  "trip.compose.stopPosition": "Stop {index} of {total}",
  ...
  "trip.compose.needTwo": "Add at least two stops to save a trip.",
  "trip.compose.save": "Save trip",
  "trip.list.stopsCount_one": "{count} stop",
  "trip.list.stopsCount_other": "{count} stops",
  ...
  "addPlace.coordsPlaceholder": "Latitude, longitude — e.g. 48.85, 2.35",
  ...
  "addPlace.locationHint": "Long-press the map to drop a pin, use your location, or type coordinates.",
  "addPlace.useLocation": "📍 Use my location",
  "addPlace.locating": "Locating…",
  "addPlace.geoUnavailable": "Couldn't get your location — long-press the map or type coordinates.",
  "addPlace.manualToggle": "Enter coordinates manually",
  "addPlace.pinnedAria": "Pinned location",
  "addPlace.swapNote": "That looks like lon, lat — saving as lat {lat}, lon {lon}.",

  // ── Journal ──────────────────────────────────────────────────────────────
  "journal.title": "Journal",
  "journal.todayStory": "Today's postcard",
  "journal.newStory": "Write a postcard",
  "journal.unplaced": "No place",
  "journal.composer.newTitle": "New postcard",
  "journal.composer.editTitle": "Edit postcard",
  "journal.composer.back": "Back",
  "journal.composer.addDetails": "Add details",
  "journal.composer.noPlace": "— no place —",
  "journal.composer.save": "Save postcard",
  "journal.composer.saveAndNew": "Save & new",
  "journal.composer.needsContent": "Write something or add a photo to save.",
  "journal.composer.tags": "Tags",
  "journal.composer.tagPlaceholder": "Add a tag and press Enter…",
  ...
  "journal.composer.endDate": "End date (optional)",
  "journal.byTag": "By tag",
  "journal.byTrip": "By trip",
  ...
  "journal.searchPlaceholder": "Search title, place, text…",
  ...
  "journal.viewByPlace": "By place",
  "journal.viewTimeline": "Timeline",
  "journal.viewMap": "Map",
  "journal.mapEmpty": "None of these entries have a place with coordinates to map yet.",
  "journal.mapAria": "Map of the places you’ve written about",
  "journal.untitledEntry": "Untitled entry",
  ...
  "map.list.headingStations": "Stations in view",
  ...
  "map.poiNoneWishlist": "None of these are on your want list yet.",
  "map.filterAria": "Filter",
  "map.filterCitiesAria": "Filter cities",
  "map.filter.all": "All",
  "map.filter.hideVisited": "Not visited",
  "map.filter.visited": "Visited",
  "map.filter.wishlist": "Want list",
  "map.filterPopAria": "Filter cities by population",
  "map.pop.heading": "People",
  "map.pop.any": "Any",
  "map.pop.10k": "10k+",
  "map.pop.100k": "100k+",
  "map.pop.1m": "1M+",
  "map.pop.anyTitle": "Show cities of any size",
  "map.pop.minTitle": "Show cities with at least {count} people",
  "map.yearFilterAria": "Filter the map by year",
  "map.year.all": "Any year",
  "map.year.noDate": "No date",
  "map.filterButton": "Filter",
  "filter.title": "Filters",
  "filter.open": "Filter",
  "filter.done": "Done",
  "filter.scope.title": "Apply to",
  "filter.scope.both": "Map & lists",
  "filter.scope.listOnly": "Lists only",
  "filter.status.title": "Status",
  "filter.status.all": "All",
  "filter.status.visited": "Visited",
  "filter.status.wishlist": "Want list",
  "filter.status.unvisited": "Not visited",
  "filter.people.title": "People",
  "filter.people.any": "Any",
  "filter.date.title": "Date",
  "filter.date.any": "Any",
  "filter.date.undated": "No date",
  "filter.date.from": "From",
  "filter.date.to": "To",
  "filter.folder.title": "Folder",
  "filter.folder.all": "All",
  "filter.sort.title": "Sort",
  "filter.sort.pop": "Most people",
  "filter.sort.az": "A–Z",
  "filter.mode.title": "Show",
  "filter.mode.all": "All",
  "filter.mode.cities": "Cities",
  "filter.mode.monuments": "Monuments",
  "filter.mode.airports": "Airports",
  "filter.mode.stations": "Stations",
  "filter.category.all": "All",
  "filter.category.cultural": "Cultural",
  "filter.category.natural": "Natural",
  "filter.category.mixed": "Mixed",
  "filter.category.aria": "Filter monuments by category",
  ...
  "filter.continent.all": "All continents",
  "filter.clearAll": "Clear all",
  "filter.removeAria": "Remove {label} filter",
  "filter.summaryAria": "Active filters",
  "filter.activeAria": "{count} filters active",
  "filter.emptyFiltered": "No places match these filters.",
  "map.filterTitle": "Filter the map by date or folder",
  "map.filterPanelAria": "Map filters",
  ...
  "map.emptyNoWishlist":
    "Nothing on your want list in this view. Switch to “All”, or flag a city to see it here.",
  ...
  "guide.sourceNote": "Overviews from Wikivoyage and Wikipedia. Links open in your browser.",
  "guide.loadingOverview": "Loading overview…",
  "guide.loadOverview": "Load overview & photo",
  "guide.offlineOff": "Overviews are off in Offline mode.",
  "guide.offlineWait": "You’re offline — the overview loads when you’re back online.",
  "guide.retry": "Retry",
  "guide.emptyOffline": "You’re offline; the links below open when you’re back online.",
  "guide.emptyOnline": "No quick overview for this exact title. Try the links or the search below.",
  "guide.photoAlt": "Photo of {place}",
  "guide.readMore": "Read more on {source}",
  "guide.savedOffline": "saved offline",
  "guide.readWhole": "Read the whole guide here",
  "guide.loadingFull": "Loading the full guide…",
  "guide.fullOffline": "You’re offline — the full guide loads when you’re back online.",
  "guide.fullEmpty": "No full guide for this exact title — the links below still work.",
  "guide.fullGuideLabel": "Full guide",
  "guide.searchFor": "Search Wikivoyage for “{query}”",
  "guide.group.explore": "Explore",
  "guide.group.understand": "Understand the country",
  "guide.group.phrasebook": "Language & alphabet",
  "guide.link.place.label": "{name} travel guide",
  "guide.link.place.hint": "See, do, eat & get around",
  "guide.link.country.label": "{name} travel guide",
  "guide.link.country.hint": "Regions, cities & practicalities",
  "guide.link.understand.label": "About {name}",
  "guide.link.understand.hint": "History, geography, culture & climate",
  "guide.link.phrasebook.label": "{name} phrasebook",
  "guide.link.phrasebook.hint": "Alphabet, pronunciation & key phrases",
  ...
  "intro.recommend.title": "You're on a phone",
  "intro.recommend.desc": "Turn on the smoother-map settings we recommend for phones — you can change them anytime in Settings.",
  "intro.recommend.apply": "Use recommended",
  "intro.recommend.toast": "Smooth-map settings on for this device.",
