...
await page.screenshot({ path: `${OUT}/postcards-mobile-map.png`, fullPage: true });
...
await page.screenshot({ path: `${OUT}/postcards-mobile-map-selected.png`, fullPage: true });

await page.getByRole("button", { name: "Stats", exact: true }).click();
await page.waitForTimeout(400);
await page.screenshot({ path: `${OUT}/postcards-mobile-stats.png`, fullPage: true });

await page.getByRole("button", { name: "Places", exact: true }).click();
await page.getByRole("tab", { name: "Countries" }).click();
await page.waitForTimeout(300);
await page.screenshot({ path: `${OUT}/postcards-mobile-countries.png`, fullPage: false });

// Desktop look.
await page.setViewportSize({ width: 1180, height: 820 });
await page.getByRole("button", { name: "Map", exact: true }).click();
await page.waitForTimeout(2500);
await page.screenshot({ path: `${OUT}/postcards-desktop-map.png` });
